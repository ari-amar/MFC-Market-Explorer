...
1. **Download:** Clone the repo or download the `index.html` file.
2. **Run:** Open `index.html` in any modern web browser (Chrome, Firefox, Edge, Safari).
3. **Data Update:** To update specifications, use the "Upload CSV" button within the interface.
